...
export default function OnboardingPhoto() {
  ...
  const openGallery = async () => {
    ...
    if (status !== 'granted') {
      Alert.alert('Permission needed', 'We need gallery permissions to select media.');
      return;
    }
      ...
      <View style={styles.content}>
        ...
        <View style={styles.photoStack}>
          ...
          <View style={[styles.photoCard, styles.photoCard1]}>
            <Image
              source={{ uri: 'https://images.unsplash.com/photo-1494790108755-2616b612b786?w=200&h=250&fit=crop&crop=face' }}
              style={styles.photo}
            />
          </View>
        </View>
